...
namespace Alt.GUI.FarseerPhysics.Demo.Testbed.Tests
{
    ...
    /// </summary>
    public class CollisionFilteringTest : FarseerPhysicsTest
    {
        const short SmallGroup = 1;
        const short LargeGroup = -1;

        const Category TriangleCategory = Category.Cat2;
        const Category BoxCategory = Category.Cat3;
        const Category CircleCategory = Category.Cat4;

        const Category TriangleMask = Category.All;
        const Category BoxMask = Category.All ^ TriangleCategory;
        const Category CircleMask = Category.All;
