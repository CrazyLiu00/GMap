...
{
    public class TheoJansenTest : FarseerPhysicsTest
    {
        ...
        private TheoJansenTest()
        {
			...
			_wheel.SetTransform(_wheel.Position, 120.0f * Alt.FarseerPhysics.Settings.Pi / 180.0f);
            CreateLeg(-1.0f, wheelAnchor);
            CreateLeg(1.0f, wheelAnchor);
        ...
        private void CreateLeg(double s, Vector2 wheelAnchor)
        {
