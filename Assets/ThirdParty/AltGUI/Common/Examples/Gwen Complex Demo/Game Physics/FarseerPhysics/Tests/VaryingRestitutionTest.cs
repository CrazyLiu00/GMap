...
{
    public class VaryingRestitutionTest : FarseerPhysicsTest
    {
        private VaryingRestitutionTest()
        {
            ...
            double[] restitution = new[] { 0.0, 0.1, 0.3, 0.5, 0.75, 0.9, 1.0 };

            for (int i = 0; i < 7; ++i)
            {
                Body body = BodyFactory.CreateCircle(World, 1.0, 1, new Vector2(-10.0 + 3.0 * i, 20.0));
