...
{
    public class AngleJointTest : FarseerPhysicsTest
    {
        AngleJointTest()
        {
            ...
            joint.TargetAngle = (double)Math.PI / 2;
            ...
            fC.Rotation = (double)(Math.PI / 3);
            fC.FixedRotation = true; // Or set the Inertia to double.MaxValue
        }
