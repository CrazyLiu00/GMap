...
namespace Alt.GUI.Temporary.Gwen.Control.OxyPlot
{
    /// <summary>
    /// Represents a control that displays a plot.
    /// </summary>
    [Serializable]
    public class Plot : DoubleBufferedControl, IPlotControl
    {
        /// <summary>
        /// The category for the properties of this control.
        /// </summary>
        const string OxyPlotCategory = "OxyPlot";
        ...
        /// </summary>
        [NonSerialized]
        ManipulatorBase mouseManipulator;
        ...
        /// The render context.
        /// </summary>
        GraphicsRenderContext renderContext;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            try
            {
                ...
                lock (this.renderingLock)
                {
                    ...
                    if (this.zoomRectangle != RectI.Empty)
                    {
                        using (var zoomBrush = new SolidColorBrush(Color.FromArgb(0x40, 0xFF, 0xFF, 0x00)))
                        using (var zoomPen = new Pen(Color.Black))
                        {
                            zoomPen.DashPattern = new double[] { 3, 1 };
        ...
        /// The mouse button.
        /// </returns>
        static OxyMouseButton ConvertChangedButton(MouseEventArgs e)
        {
            switch (e.Button)
            {
        ...
        /// </returns>
        OxyMouseEventArgs CreateMouseEventArgs(MouseEventArgs e)
        {
        ...
        /// </returns>
        ManipulatorBase GetManipulator(MouseEventArgs e)
        {
