...
{
    class Example_NPlot_Tour : Example__Base
    {
        Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl m_PlotSurface;
		Alt.GUI.Temporary.Gwen.Control.Label m_ExampleNumberLabel;
		Alt.GUI.Temporary.Gwen.Control.Label m_InfoBox;

        GUI.Timer qeExampleTimer;

        readonly Color plotSurface_BackColor_Default = Color.Transparent;
        ...
        static double[] PlotQEExampleValues;
        static string[] PlotQEExampleTextValues;


        public Example_NPlot_Tour(Base parent)
            : base(parent)
        {
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            qeExampleTimer = new GUI.Timer();
            qeExampleTimer.Interval = 500;
            qeExampleTimer.Tick += new System.EventHandler(qeExampleTimer_Tick);


            m_PlotSurface = new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl(this);
            m_PlotSurface.Margin = new Margin(20);
            m_PlotSurface.Dock = Pos.Fill;

            m_PlotSurface.AutoScaleAutoGeneratedAxes = false;
            m_PlotSurface.AutoScaleTitle = false;
            m_PlotSurface.DateTimeToolTip = false;
            m_PlotSurface.Legend = null;
            m_PlotSurface.LegendZOrder = -1;
            m_PlotSurface.Location = new PointI(8, 8);
            m_PlotSurface.Name = "plotSurface";
            m_PlotSurface.RightMenu = null;
            m_PlotSurface.ShowCoordinates = false;
            m_PlotSurface.Size = new SizeI(356, 360);
            m_PlotSurface.SmoothingMode = SmoothingMode.AntiAlias;// None;
            m_PlotSurface.SurfacePadding = 10;
            m_PlotSurface.Title = "";
            m_PlotSurface.TitleFont = new Font("Arial", 14F, FontStyle.Regular, GraphicsUnit.Pixel);
            m_PlotSurface.XAxis1 = null;
            m_PlotSurface.XAxis2 = null;
            m_PlotSurface.YAxis1 = null;
            m_PlotSurface.YAxis2 = null;


            SetPlotDefaultBackColor();


			Base controlsMain = new Alt.GUI.Temporary.Gwen.Control.Base(this);
            controlsMain.Dock = Pos.Top;
            controlsMain.Height = 38;
            controlsMain.Margin = new Margin(20, 10, 20, 0);
            ...
            backButton.Click += new EventHandler(prevPlotButton_Click);
            backButton.SetToolTipText("Prev");
            backButton.SetImage("AltData/Back.png", true);
            backButton.Width = 36;
            backButton.Margin = new Margin(70, 1, 0, 1);
            ...
            forwardButton.Click += new EventHandler(nextPlotButton_Click);
            ...
            m_ExampleNumberLabel.Margin = new Margin(5, (controlsMain.Height - m_ExampleNumberLabel.Height) / 2 - 3, 5, 1);
            m_ExampleNumberLabel.ClientBackColor = Color.FromArgb(96, Color.Black);
            

			m_InfoBox = new Alt.GUI.Temporary.Gwen.Control.Label(this);
            m_InfoBox.Dock = Pos.Bottom;
            m_InfoBox.AutoSizeToContents = true;
            m_InfoBox.TextColor = Color.LightBlue;
            m_InfoBox.Margin = new Margin(20, 0, 20, 10);
            m_InfoBox.Text = "";
            ...
            PlotRoutines = new PlotDemoDelegate[] {    
													    ...
													    //TEMP  new PlotDemoDelegate(PlotImage),
            ...
            m_PlotSurface.RightMenu = m_PlotSurface.DefaultContextMenu;
        ...
        void SetPlotDefaultBackColor()
        {
            m_PlotSurface.ClientBackColor = plotSurface_BackColor_Default;

            m_PlotSurface.TitleColor = plotSurface_Label_Default;

            if (m_PlotSurface.XAxis1 != null)
            {
                m_PlotSurface.XAxis1.AxisColor = plotSurface_AxisColor_Default;
                m_PlotSurface.XAxis1.TickTextColor = plotSurface_TickTextColor_Default;
                m_PlotSurface.XAxis1.LabelColor = plotSurface_Label_Default;
            }

            if (m_PlotSurface.YAxis1 != null)
            {
                m_PlotSurface.YAxis1.AxisColor = plotSurface_AxisColor_Default;
                m_PlotSurface.YAxis1.TickTextColor = plotSurface_TickTextColor_Default;
                m_PlotSurface.YAxis1.LabelColor = plotSurface_Label_Default;
            }
        }

        void SetPlotBackColor(Color color)
        {
            m_PlotSurface.ClientBackColor = color;
        }


        void SetInfo(string[] lines)
        {
            string text = "";
        ...
        void RunCurrentPlot()
        {
            ...
            m_ExampleNumberLabel.Text = " Plot " + id.ToString("0") + "/" + PlotRoutines.Length.ToString("0") + " ";
            m_PlotSurface.DateTimeToolTip = false;
        ...
        void PlotCircular()
        {
            ...
            m_PlotSurface.Clear();
            PlotCircular(m_PlotSurface.Inner);
        ...
        public static void PlotCircular(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
        ...
        void PlotWavelet()
        {
            ...
            m_PlotSurface.Clear();
            PlotWavelet(m_PlotSurface.Inner);
        ...
        public static void PlotWavelet(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
        ...
        void PlotLogAxis()
        {
            ...
            m_PlotSurface.Clear();
            PlotLogAxis(m_PlotSurface.Inner);

            SetPlotDefaultBackColor();
            Axis loga = m_PlotSurface.Inner.YAxis1;
            loga.AxisColor = Color.Red;
            loga.LabelColor = Color.LightPink;
            loga.TickTextColor = Color.LightPink;
            Axis lin = m_PlotSurface.Inner.YAxis2;
            lin.AxisColor = Color.Blue;
            lin.LabelColor = Color.LightBlue;
            lin.TickTextColor = Color.LightBlue;

            m_PlotSurface.Refresh();
        }

        public static void PlotLogAxis(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
        ...
        void PlotLogLog()
        {
            ...
            m_PlotSurface.Clear();
            PlotLogLog(m_PlotSurface.Inner);

            SetPlotDefaultBackColor();
            Axis logax = m_PlotSurface.Inner.XAxis1;
            logax.AxisColor = Color.Red;
            logax.LabelColor = Color.LightPink;
            logax.TickTextColor = Color.LightPink;
            Axis logay = m_PlotSurface.Inner.YAxis1;
            logay.AxisColor = Color.Red;
            logay.LabelColor = Color.LightPink;
            logay.TickTextColor = Color.LightPink;
            Axis linx = m_PlotSurface.Inner.XAxis2;
            linx.AxisColor = Color.Blue;
            linx.LabelColor = Color.LightBlue;
            linx.TickTextColor = Color.LightBlue;
            Axis liny = m_PlotSurface.Inner.YAxis2;
            liny.AxisColor = Color.Blue;
            liny.LabelColor = Color.LightBlue;
            liny.TickTextColor = Color.LightBlue;

            m_PlotSurface.Refresh();
        }

        public static void PlotLogLog(PlotSurface2D plotSurface)
		{
            // log log plot
			plotSurface.Clear();
        ...
        void PlotSincFunction()
        {
            ...
            m_PlotSurface.Clear();
            PlotSincFunction(m_PlotSurface.Inner);
        ...
        public static void PlotSincFunction(PlotSurface2D plotSurface)
		{
        ...
        void PlotGaussian()
        {
            ...
            m_PlotSurface.Clear();
            PlotGaussian(m_PlotSurface.Inner);
        ...
        public static void PlotGaussian(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
        ...
        void PlotABC()
        {
            ...
            m_PlotSurface.Clear();
            PlotABC(m_PlotSurface.Inner);

            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.MouseWheelZoom());

            //plotSurface.BackColor = AltSketch.SystemColors.Control;
            SetPlotDefaultBackColor();

            m_PlotSurface.Refresh();
        }

        public static void PlotABC(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
			...
			System.IO.Stream file = Alt.IO.VirtualFile.OpenRead("AltData/NPlot/pattern01.jpg");
            Bitmap im = Bitmap.FromStream(file);
            plotSurface.PlotBackImage = im;// new Bitmap(im);
        ...
        void PlotLabelAxis()
        {
            ...
            m_PlotSurface.Clear();
            PlotLabelAxis(m_PlotSurface.Inner);
        ...
        public static void PlotLabelAxis(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
        ...
        void PlotParticles()
        {
            ...
            m_PlotSurface.Clear();
            PlotParticles(m_PlotSurface.Inner);

            SetPlotDefaultBackColor();
            Axis loga = m_PlotSurface.Inner.YAxis2;
            loga.LabelColor = plotSurface_TickTextColor_Default;
            loga.TickTextColor = plotSurface_TickTextColor_Default;

            // Finally, refreshes the plot
            m_PlotSurface.Refresh();
        }

        public static void PlotParticles(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
		...
		static void TwissEllipse(float a, float b, float g, float e, ref float [] x, ref float [] y)
		{
		...
		static void Twiss(float [] x, float [] y, out float a, out float b, out float g, out float e)
		{
        ...
        public static void PlotQE(PlotSurface2D plotSurface)
		{
			plotSurface.Clear();
        ...
        void PlotDataSet()
        {
            ...
            m_PlotSurface.Clear();
            PlotDataSet(m_PlotSurface.Inner);

            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.HorizontalDrag());
            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.VerticalDrag());
            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.AxisDrag(true));
        ...
        void PlotImage()
        {
            ...
            m_PlotSurface.Clear();
            PlotImage(m_PlotSurface.Inner);

            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.RubberBandSelection());
        ...
        public static void PlotImage(PlotSurface2D plotSurface)
		{
			string myfile = 
	...
	"-2.113445E-3 -1.140148E-3 -1.195765E-3 -1.140148E-3 -1.167957E-3 -7.786377E-4 -8.342547E-4 -3.893189E-4 -4.171273E-4 -1.279191E-3 -1.251382E-3 -1.195765E-3 -1.195765E-3 -8.342547E-4 -8.620631E-4 -1.223573E-3 -1.251382E-3 -1.612892E-3 -1.668509E-3";
			...
			//plotSurface.SmoothingMode = SmoothingMode.None;
        ...
        void PlotMarkers()
        {
            ...
            m_PlotSurface.Clear();
            PlotMarkers(m_PlotSurface.Inner);
        ...
        public static void PlotMarkers(PlotSurface2D plotSurface)
		{
            plotSurface.Clear();
			
			double[] y = new double[1] {1.0f};
			foreach (object i in
                //Enum.GetValues(typeof(Marker.MarkerType))
                EnumHelper.GetValues<Marker.MarkerType>()
                )
			{
				Marker m = new Marker( (Marker.MarkerType)EnumHelper.Parse(typeof(Marker.MarkerType), i.ToString()), 8 );
        ...
        {
            m_PlotSurface.Clear();
            PlotCandle(m_PlotSurface.Inner);
        ...
        public static void PlotCandle(PlotSurface2D plotSurface)
		{
			plotSurface.Clear();
        ...
        public static void PlotTest(PlotSurface2D plotSurface)
		{
			plotSurface.Clear();
        ...
        void PlotWave()
        {
            ...
            m_PlotSurface.Clear();
            PlotWave(m_PlotSurface.Inner);

            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.VerticalGuideline());
            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.HorizontalRangeSelection(3));
            m_PlotSurface.AddInteraction(new Alt.GUI.NPlot.Temporary.Gwen.PlotSurface2DControl.Interactions.AxisDrag(true));

            //SetPlotBackColor(Color.Black);
            SetPlotDefaultBackColor();
            m_PlotSurface.Inner.PlotBackColor = Color.DarkBlue;
            m_PlotSurface.Inner.XAxis1.Color = Color.WhiteSmoke;
            m_PlotSurface.Inner.YAxis1.Color = Color.WhiteSmoke;

            m_PlotSurface.Refresh();
        }

        public static void PlotWave(PlotSurface2D plotSurface)
		{
            System.IO.Stream file = Alt.IO.VirtualFile.OpenRead("AltData/NPlot/light.wav");
        ...
        {
            m_PlotSurface.Clear();
            PlotMultiHistogram(m_PlotSurface.Inner);
        ...
        public static void PlotMultiHistogram(PlotSurface2D plotSurface)
        {
        ...
        void PlotCandleSimple()
        {
            ...
            m_PlotSurface.Clear();
            PlotCandleSimple(m_PlotSurface.Inner);
        ...
        public static void PlotCandleSimple(PlotSurface2D plotSurface)
        {
            plotSurface.Clear();
        ...
        void PlotMockup()
        {
            ...
            m_PlotSurface.Clear();
            PlotMockup(m_PlotSurface.Inner);
        ...
        public static void PlotMockup(PlotSurface2D plotSurface)
		{
			...
			storeGrowth.FillBrush = RectangleBrushes.Solid.Black;
			...
			averageGrowth.FillBrush = RectangleBrushes.Solid.Gray;
            ...
            l.AttachTo(PlotSurface2D.XAxisPosition.Bottom, PlotSurface2D.YAxisPosition.Left);
			l.HorizontalEdgePlacement = Legend.Placement.Outside;
			l.VerticalEdgePlacement = Legend.Placement.Inside;
			l.XOffset = 5;
			l.YOffset = 50;
			l.BorderStyle = LegendBase.BorderType.Line;
        ...
        {
            m_PlotSurface.Clear();
            PlotProfitLoss(m_PlotSurface.Inner);
		...
		public static void PlotProfitLoss(PlotSurface2D plotSurface)
		{
